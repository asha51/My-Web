...
================================================== -->
    <div class="container">
        <div class="mainheading">
            ...
            <p class="lead">
                WellCome To MyWeb App WORLD, Learn New thinds!!!!
            </p>
        </div>
        <!-- End Site Title
================================================== -->
            ...
            <div class="card-columns listfeaturedtag">
                                ...
                                <div class="metafooter">
                                    <div class="wrapfooter">
                                        <span class="meta-footer-thumb">
                                            <a href="author.html"><img class="author-thumb" src="" alt="Sal"></a>
                                        </span>
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-5 wrapthumbnail">
                            <a href="post.html">
                                <div class="thumbnail" style="background-image:url(assets/img/asha.jpg);">
                                </div>
                            </a>
                        </div>
                        <div class="col-md-7">
	...
	================================================== -->
        <section class="recent-posts">
            <div class="section-title"><h2><span>All Stories</span></h2></div>
            <div class="row all-stories listrecent mb-5">
                <div class="col-m-12 col-sm-4 " >
                     <!-- begin post -->
                <div class="card">
                    <a href="post.html"><img class="img-fluid" src="assets/img/demopic/5.jpg" alt=""> </a>
                    <div class="card-block">
...
<!-- Begin Footer
	...
	<div class="footer">
		<p class="pull-left">
			 Copyright &copy; 2017 MyWeb
		</p>
		<p class="pull-right">
			 AshaSuthar by <a target="_blank" href="https://www.wowthemes.net">hopeWorld.com</a>
		</p>
		<div class="clearfix">
		</div>
	</div>
